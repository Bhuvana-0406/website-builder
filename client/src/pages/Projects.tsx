...
import { ArrowBigDown, ArrowBigDownDashIcon, EyeIcon, EyeOff, FullscreenIcon, Laptop, Loader2Icon, MessagesSquareIcon, SaveIcon, SmartphoneIcon, TabletIcon, XIcon } from 'lucide-react'
      ...
      <div className='flex max-sm:flex-col sm:items-center gap-4 px-4 py-2 no-scrollbar'>
          ...
          <div className='flex items-center gap-2 sm:min-w-90 text-nowrap'>
              ...
              <div className='sm:hidden flex-1 flex justify-end'>
                  {isMenuOpen ? <MessagesSquareIcon className='size-6 cursor-pointer' onClick={()=> setIsMenuOpen(false)} />
          ...
          <div className='flex items-center justify-end gap-3 flex-1 text-xs sm:text-sm'>
              ...
              {project.isPublished ? <EyeOff size={16} /> : <EyeIcon size={16} />} 
