...
import framer2logo from "../assets/framerlogo-removebg-preview.png";
import huaweilogo from "../assets/huaweilogo-removebg-preview.png";
import instalogo from "../assets/instalogo-removebg-preview.png";
import mslogo from "../assets/mslogo-removebg-preview.png";
import walmartlogopng from "../assets/walmart-logo-png-3-removebg-preview.png";
  ...
  return (
    <section className="flex flex-col items-center text-white text-sm pb-20 px-4 font-poppins">
      ...
      >
        ...
        <button className="ml-auto flex items-center gap-2 bg-gradient-to-r from-[#CB52D4] to-indigo-600 rounded-md px-4 py-2">
          {!loading ? (
            ...
            <>
              Creating{" "}
              <Loader2Icon className="animate-spin size-4 text-white"></Loader2Icon>
            </>
          )}
      ...
      <div className="flex flex-wrap items-center justify-center gap-16 md:gap-20 mx-auto mt-16">
        <img className="max-w-28 md:max-w-29" src={framer2logo} alt="framer" />
        <img className="max-w-28 md:max-w-30" src={huaweilogo} alt="huawei" />
        <img className="max-w-28 md:max-w-32" src={instalogo} alt="instagram" />
        <img className="max-w-28 md:max-w-32" src={mslogo} alt="microsoft" />
        <img className="max-w-28 md:max-w-40" src={walmartlogopng} alt="walmart" />
      </div>
    </section>
  );
};
