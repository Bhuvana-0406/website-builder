import { CircleCheckIcon, ScanLineIcon, SquareIcon, TriangleIcon } from 'lucide-react'
import { useEffect, useState } from 'react'
const steps = [
    {icon: ScanLineIcon,label:"Analysing your request..."},
    {icon: SquareIcon,label:"Generating layout strucutre..."},
    {icon: TriangleIcon,label:"Assembling UI components..."},
    {icon: CircleCheckIcon,label:"Finalising your website..."},
...
const LoaderSteps = () => {
  ...
  return (
    <div className='w-full h-full flex flex-col items-center justify-center bg-gray-950 relative overflow-hidden text-white'>
      ...
      {/* step label - fade using transition only (no invisble start) */}
