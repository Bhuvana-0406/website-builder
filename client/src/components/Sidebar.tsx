      ...
      <div className='flex flex-col h-full'>
        ...
        .sort((a,b)=> new Date(a.timestamp).getTime() - new Date(b.timestamp).getTime()).map((message)=>{
            ...
            if(isMessage){
                ...
                return (
                    <div key={ver.id} className='w-4/5 mx-auto my-2 p-3 rounded-xl bg-gray-800 text-gray-100 flex flex-col gap-2'>
                    ...
                    {project.current_version_index === ver.id ? (
                        ...
                        <button className='px-3 py-1 rounded-md text-xs bg-indigo-500 hover:bg-indigo-600 text-white' onClick={()=> handleRollback(ver.id)}>Roll back to this version</button>
                    )}
